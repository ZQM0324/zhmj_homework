...
class Drowsiness_MainWindow(QBeautyUI):
    ...
    def LoadModel(self, model_path=None):
        ...
        parser.add_argument('--weights', nargs='+', type=str, default='../weights/drowsiness-best.pt',
    ...
    def setting(self):
        QMessageBox.about(self.centralwidget, "",  "<A href=''>"
                                                     "</a>")
