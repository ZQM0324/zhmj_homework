...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='/Drowsiness/drowsiness.yaml', help='garbage.yaml path')
    ...
    parser.add_argument('--logdir', type=str, default='Drowsiness/logs', help='logging directory')
